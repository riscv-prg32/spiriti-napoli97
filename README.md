...
- **Actual-asset previews:** `actual-assets-sheet.png`, `actual-tile-scenes.png` and `screenshot.png` are generated from the same runtime data/source art used by the cartridge; they are not the earlier concept sheet.
